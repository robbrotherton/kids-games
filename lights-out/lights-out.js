class LightsOut {
    constructor() {
        ...
        this.moves = 0;
        this.gameWon = false;
        this.optimalMoves = 0; // Will be set when new game starts
    ...
    updateDisplay() {
        // Update moves counter with static optimal moves
        this.movesText.textContent = `Moves: ${this.moves} (Optimal: ${this.optimalMoves})`;
    ...
    startNewGame() {
        ...
        // Calculate optimal moves for this specific puzzle and store it
        const solution = this.solve4x4(this.board);
        this.optimalMoves = solution ? solution.length : '?';
        
        // Debug: Show the optimal solution length
        console.log(`New puzzle generated. Optimal solution requires ${this.optimalMoves} moves.`);
